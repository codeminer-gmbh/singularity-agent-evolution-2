    ...
    def definitions(self) -> tuple[ToolDefinition, ...]:
        ...
        return (
            ...
            ToolDefinition(
                name="read_document",
                description=(
                    "Extract text, tables, tracked revisions and comments from Word DOCX, and speaker notes from PDF, Excel XLSX, OpenDocument ODS, PowerPoint PPTX, EPUB, RFC 822 EML email, or Outlook MSG email "
