...
`inspect_document` handles common binary attachments directly: DOCX and PPTX package text plus review comments; XLSX worksheet coordinate/value evidence (including shared and inline strings, numeric/boolean values, formulas, and comments); ODT, ODS, and ODP package text; EPUB spine chapters; local HTML/HTM/XHTML visible text, links, and table rows; PDF embedded text and page OCR; and image OCR. This lets a
